...
class fsm_simple_pid(fsm_state):
    def __init__(self):
        ...
        self.turn_pid = pid(1,0,0) #YAW ONLY
    ...
    def init_vertical_callback(self, data):
        self.init_vertical = data.data
    ...
    def compRun(self, dt, targetGoal):        # Axises are messed up so z is 0  
        ...
        self.thrust_list[2] = forward_bias + 1
        self.thrust_list[3] = forward_bias - 1
        self.thrust_list[4] = vertical_bias - 3
        self.thrust_list[5] = vertical_bias - 3.6 + .4
